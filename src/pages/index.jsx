...
const Index = () => {
    return (
      <>
        <Layout>
          {/* Hero section */}
          <section className='bg-[#F7F7F7] w-full h-auto pb-20'>
            <div className='mx-52 flex flex-col justify-center items-center text-center space-y-4'>
              <h1 className='font-medium text-4xl mt-28'>Handcrafted Soap for <br/> Natural skincare</h1>
              ...
              <img src="/src/assets/img/Hero.jpeg" alt="Hero Image" className='mx-52 w-full mt-28 object-cover'/>
            </div>
          </section>
          ...
          <section className='pt-14 pb-20'>
            ...
            {/* Card benefits */}
            <div className='mx-52 mt-12 grid grid-cols-4 gap-10'>
              {/* <CardTest
              ...
              <CardBenefits
                title="Skin-loving"
                icon={<Bath className="text-green-600" size={32} />}
